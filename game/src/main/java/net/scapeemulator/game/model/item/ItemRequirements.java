	...
	public static boolean checkRequirements(Player player, Item item) {
		...
		if (name.contains("bronze")) {
			if (slot == Equipment.WEAPON) {
				if (player.getSkillSet().getLevel(Skill.ATTACK) >= BRONZE_LEVEL_REQ) {
					return true;
				} else {
					...
					|| slot == Equipment.FEET) {
				if (player.getSkillSet().getLevel(Skill.DEFENCE) >= BRONZE_LEVEL_REQ) {
					return true;
				} else {
		...
		if (name.contains("iron")) {
			if (slot == Equipment.WEAPON) {
				if (player.getSkillSet().getLevel(Skill.ATTACK) >= IRON_LEVEL_REQ) {
					return true;
				} else {
					...
					|| slot == Equipment.BODY || slot == Equipment.LEGS
					|| slot == Equipment.FEET) {
				if (player.getSkillSet().getLevel(Skill.DEFENCE) >= IRON_LEVEL_REQ) {
					return true;
				} else {
		...
		if (name.contains("steel")) {
			if (slot == Equipment.WEAPON) {
				if (player.getSkillSet().getLevel(Skill.ATTACK) >= STEEL_LEVEL_REQ) {
					return true;
				} else {
					...
					|| slot == Equipment.BODY || slot == Equipment.LEGS
					|| slot == Equipment.FEET) {
				if (player.getSkillSet().getLevel(Skill.DEFENCE) >= STEEL_LEVEL_REQ) {
					return true;
				} else {
		...
		if (name.contains("mith")) {
			if (slot == Equipment.WEAPON) {
				if (player.getSkillSet().getLevel(Skill.ATTACK) >= MITH_LEVEL_REQ) {
					return true;
				} else {
					...
					|| slot == Equipment.BODY || slot == Equipment.LEGS
					|| slot == Equipment.FEET) {
				if (player.getSkillSet().getLevel(Skill.DEFENCE) >= MITH_LEVEL_REQ) {
					return true;
				} else {
		...
		if (name.contains("adamant")) {
			if (slot == Equipment.WEAPON) {
				if (player.getSkillSet().getLevel(Skill.ATTACK) >= ADDY_LEVEL_REQ) {
					return true;
				} else {
					...
					|| slot == Equipment.BODY || slot == Equipment.LEGS
					|| slot == Equipment.FEET) {
				if (player.getSkillSet().getLevel(Skill.DEFENCE) >= ADDY_LEVEL_REQ) {
					return true;
				} else {
		...
		if (name.contains("rune") || name.contains("d'hide body")) {
			if (slot == Equipment.WEAPON) {
				if (player.getSkillSet().getLevel(Skill.ATTACK) >= RUNE_LEVEL_REQ) {
					return true;
				} else {
					...
					|| slot == Equipment.BODY || slot == Equipment.LEGS
					|| slot == Equipment.FEET) {
				if (player.getSkillSet().getLevel(Skill.DEFENCE) >= RUNE_LEVEL_REQ) {
					return true;
				} else {
		...
		if (name.contains("granite")) {
			if (slot == Equipment.WEAPON) {
				if (player.getSkillSet().getLevel(Skill.ATTACK) >= GRANITE_LEVEL_REQ) {
					return true;
				} else {
					...
					|| slot == Equipment.BODY || slot == Equipment.LEGS
					|| slot == Equipment.FEET) {
				if (player.getSkillSet().getLevel(Skill.DEFENCE) >= GRANITE_LEVEL_REQ) {
					return true;
				} else {
		...
		if (name.contains("dragon")) {
			if (slot == Equipment.WEAPON) {
				if (player.getSkillSet().getLevel(Skill.ATTACK) >= DRAGON_LEVEL_REQ) {
					return true;
				} else {
					...
					|| slot == Equipment.BODY || slot == Equipment.LEGS
					|| slot == Equipment.FEET) {
				if (player.getSkillSet().getLevel(Skill.DEFENCE) >= DRAGON_LEVEL_REQ) {
					return true;
				} else {
		...
		if (name.contains("verac") || name.contains("dharok") || name.contains("ahrim") || name.contains("torag") || name.contains("karil") || name.contains("guthan")) {
			if (slot == Equipment.WEAPON) {
				if (player.getSkillSet().getLevel(Skill.ATTACK) >= BARROWS_LEVEL_REQ) {
					return true;
				} else {
					...
					|| slot == Equipment.BODY || slot == Equipment.LEGS
					|| slot == Equipment.FEET) {
				if (player.getSkillSet().getLevel(Skill.DEFENCE) >= BARROWS_LEVEL_REQ) {
					return true;
				} else {
		...
		if (name.contains("whip")) {
			if (slot == Equipment.WEAPON) {
				if (player.getSkillSet().getLevel(Skill.ATTACK) >= 70) {
					return true;
				} else {
		...
		if (name.contains("godsword") || name.contains("dragonfire")) {
			if (slot == Equipment.WEAPON) {
				if (player.getSkillSet().getLevel(Skill.ATTACK) >= OP_LEVEL_REQ) {
					return true;
				} else {
				...
				if (player.getSkillSet().getLevel(Skill.DEFENCE) >= OP_LEVEL_REQ) {
					return true;
				} else {
